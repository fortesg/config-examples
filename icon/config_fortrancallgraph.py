...
EXCLUDE_MODULES = [ 'iso_fortran_env', 'iso_c_binding', 'ifcore', 'mpi', 'omp_lib', #Standard libraries
                    ...
                    'mo_assimi_process', 'mo_a2l_memory_class', 'mo_atmland_interface', 'mo_carbon_constants', 
                    'mo_carbon_memory_class', 'mo_hd_config_class', 'mo_hd_init', 'mo_hd_interface', 
                    'mo_hd_memory_class', 'mo_hd_reservoir_cascade', 'mo_hsm_class', 'mo_hydro_config_class', 
                    'mo_hydro_constants', 'mo_hydro_init', 'mo_hydro_interface', 'mo_hydro_memory_class', 
                    'mo_hydro_process', 'mo_hydro_util', 'mo_interface_hd_ocean', 
